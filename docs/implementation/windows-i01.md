...
2026-09-22 的 A／B／D 和 C 复测 PASS 保留为原版本证据。2026-09-23 复审新增两项异常路径问题，已修复，**当前等待复审及新版本定向回归，暂不适合 merge**。已做过四轮的操作者只需使用[复审回归手册](windows-review-regression.md)，无须重做本页全部轮次。
